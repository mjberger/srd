...
Although the small cells do not mimic the cut cells at the boundary in higher dimensions, this is
still a useful model problem. 
...
The finite volume method \eqref{eq:unstable1d} is called the base scheme.  
