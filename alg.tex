...
\hspace*{.5in}
	...
	\hfill
	\subfloat[\sf $3\times 3$ merging neighborhood for the cut cell $(i,j)$.]{\includegraphics[width=.35\textwidth]{figs/normaldirection2.pdf} \label{fig:3x3neighborhood}}
...
The set of neighborhoods used for gradient reconstruction on neighborhood $(i,j)$, $\widehat R_{i,j}$, that we use is the $3 \times 3$ tile.
