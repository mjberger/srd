...
The steps above can be part of a preprocessing step, since they do not
...
WHAT ABOUT LIMITING THE GRADIENT?  

Note that full cells, where the merging solution $\widehat{Q} = \widehat{U}$, the
...
{\bf The merging neighborhoods contribute their solution to the cut cells and
adjacent full cell neighbors, replacing the provisionally computed solution.} 
