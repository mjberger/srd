...
the cut cells and tiles, but only the first derivative terms are used; 
the second order derivatives are subsequently ignored.  
...
\centering
	...
	\subfloat[$L_1$ volume errors. \label{tab:ex1_L1vol}]{
		\begin{tabular}{|l|c|l|l||l|l|}
			\hline
			$h$ & $N_x ,N_y$ & \multicolumn{2}{|c||}{Local Time Stepping (no SRD)} & \multicolumn{2}{|c|}{State Redistribution}  \\
			\hline
			& & 1st order grad. & 2nd order grad. & 1st order grad. & 2nd order grad. \\
			\hline
			.5297 & 27 & 6.09e-3  & 2.58e-3 & 6.75e-3 & 2.76e-3 \\
			\hline
			.2648 & 54  & 1.67e-3  (3.6)  & 6.39e-4 (4.0) & 1.78e-4 (3.8)  & 6.38e-4 (4.3) \\
			\hline
			.1324 &108 & 3.41e-3  (4.9)  & 1.50e-4 (4.3) & 3.63e-4 (4.9)  & 1.53e-4 (4.2) \\
			\hline
			.662E-2 & 216 & 6.62e-5  (5.2)  & 3.61e-5 (4.2) & 6.52e-5 (5.6)  & 3.65 e-5  (4.2)\\
			\hline
			.331E-2 & 432 & 1.34e-5  (4.9)  & 8.70e-6 (4.1) & 1.40e-5 (4.7)  & 8.85 e-6  (4.1)\\
			\hline
			.166E-2 & 864 & 2.59e-6  (5.2)  & 2.11e-6 (4.1) & 2.68e-6 (5.2)  & 2.15 e-6  (4.1)\\
			\hline \hline
		\end{tabular}
	}
	\quad
	...
	\hline
	    &    & 1st order grad.  & 2nd order grad.  & 1st order grad.  & 2nd order grad.  \\
	\hline
     .5297 & 	27  &  6.75e-02       &   3.41e-02 &  6.84e-02 &  3.31e-02 \\
	\hline
     .2648 &	54  &  2.79e-02  (2.4) &   1.27e-02 (2.7)  &  2.83e-02 (2.4) &  1.21e-02 (2.7) \\
	\hline
      .1324 &	108 &  1.00e-02  (2.8) &   4.81e-03  (2.7) &  1.03e-02  (2.8)&  4.69e-03 (2.6)\\
	\hline
     .662E-2 &	216 &  3.51e-03  (2.9) &   1.88e-03  (2.6) &  3.65e-03  (2.8)&  1.82e-03 (2.6) \\
			\hline
    .331E-2 &			432 &  1.21e-03  (2.9) &   7.23e-04 (2.6)  &  1.24e-03  (3.0)  &  7.18e-04 (2.6) \\
			\hline
    .166E-2 &		864 &  3.78e-04  (3.2) &   2.82e-04 (2.6)  &  3.96e-04  (3.1)  &  2.85e-04 (2.6) \\
			\hline \hline
		\end{tabular}
	}
	...
	\caption{\sf L1 norm of the error in the domain volume and along the boundary,
        ...
        of using local time stepping (LTS, which does not require SRD)
        versus using SRD and a full $\Delta t$.\label{tab:ssv}}
\end{table}
}
...
This is a common practise, since it provides better results than first order
gradients and is it much easier to implement (although for computing gradient
of cut cells it is not really difficult). 
Technically it does not produce a second order accurate gradient.
On SRD neighboroods the integral average  is more complicated 
to implement since one needs to compute the weighted volumes of the
merging neighborhoods. 
The results however are almost 10\% more 
accurate on the coarser grids for cut-cell gradients alone using LTS,
and range from  5 to 25\% more accurate for SRD reconstruction. 
MAYBE GIVE SEPARATE TABLE FOR THIS. 20  IS A LOT
%More information about the first and second order gradient reconstructions can be 
%found in Sections \ref{sec:limit} and \ref{sec:srd_postprocessing}.
