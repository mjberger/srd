...
\begin{figure}
	\centering
	\includegraphics[width=0.35\linewidth]{figs/supersonicdomain}
...
$$
% given in Table \ref{tab:ex2_L1} and \ref{tab:ex2_Linf}. 
...
\begin{figure}
	\subfloat[Coordinate aligned reflecting boundary.]{\includegraphics[width = 0.6\linewidth]{figs/dmca} \label{fig:dmca}} 
	\hfill
	\subfloat[Non-coordinate aligned reflecting boundary.]{\includegraphics[width = 0.3\linewidth]{figs/dmnca}\label{fig:dmnca}}
\end{figure}
This problem is solved using the finite volume TVD-RK2 scheme. 
