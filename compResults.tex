...
\includegraphics[width = 0.6\linewidth]{figs/waveyiso.eps} 
%\subfloat[Isolines of exact solution at the initial and final time.]{\includegraphics[width = 0.5\linewidth]{figs/waveyiso.eps} \label{fig:waveyisolines}} 
\caption{Isolines of exact solution at the initial and final time for
the wavy domain with overlapping neighborhoods.} 
