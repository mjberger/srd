...
On nonuniform grids, the truncation error is $||\tau|| = \mathcal{O}(h^{p})$.  
...
%\begin{figure}
%    \centering
%\subfloat[Uniform grid.]{\includegraphics[width=0.45\linewidth]{figs/truncationerror_uniform.pdf}} \hfill
%\subfloat[Nonuniform grid.]{\includegraphics[width=0.45\linewidth]{figs/truncationerror_nonuniform.pdf}}
